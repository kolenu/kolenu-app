class LegalText {
  static const String usageDisclaimerTitle = 'Kolenu™ Usage Disclaimer';
  static const String usageDisclaimerContent =
  ...
  static const String copyrightIpTitle = 'Copyright & IP Protection';
  static const String copyrightIpContent =
  ...
  static const String termsOfServiceContent =
      ...
      'By downloading, installing, accessing, or using Kolenu (the "App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.\n\n'
      '2. PERMITTED USE\n'
      'You may use the App for personal, non-commercial, educational, and religious study purposes only. You may not copy, reproduce, modify, reverse engineer, distribute, sell, sublicense, or otherwise exploit the App or any part of it without prior written permission from DigiMint Inc.\n\n'
      '3. INTELLECTUAL PROPERTY\n'
      'The App and its software, design, text, images, trademarks, and other materials are owned by DigiMint Inc or its licensors and are protected by applicable intellectual property laws. Certain materials (including, where applicable, audio recordings, prayers, melodies, and playlists) may be proprietary and/or licensed from third parties and are not granted under the App software license except as expressly stated.\n\n'
      '4. NO USER UPLOADS (CURRENT VERSION)\n'
      'The current version of the App does not permit user-generated content uploads. If such features are added in the future, additional terms may apply.\n\n'
      '5. DISCLAIMER OF WARRANTIES\n'
      'The App is provided "as is" and "as available," without warranties of any kind, express or implied, including without limitation warranties of merchantability, fitness for a particular purpose, non-infringement, availability, or accuracy.\n\n'
      '6. LIMITATION OF LIABILITY\n'
      'To the maximum extent permitted by law, DigiMint Inc and its affiliates, officers, employees, and licensors are not liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of data, goodwill, or profits, arising out of or related to your use of, or inability to use, the App.\n\n'
      '7. GOVERNING LAW AND JURISDICTION\n'
      'These Terms are governed by the laws of the Province of British Columbia and the federal laws of Canada applicable therein. Any dispute arising out of or relating to these Terms shall be brought exclusively in the courts located in Vancouver or Richmond, British Columbia, Canada.\n\n'
      '8. CHANGES TO TERMS\n'
      ...
      '9. CONTACT\n'
      'For questions about these Terms, contact: info@digimint.ca';
  ...
  static const String licenseTitle = 'License (BSL 1.2)';
  static const String licenseContent =
