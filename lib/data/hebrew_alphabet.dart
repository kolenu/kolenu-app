...
const List<HebrewLetter> hebrewLetters = [
  ...
  HebrewLetter(
    ...
    hasDagesh: true,
    charWithDagesh: 'כּ',
    soundWithoutDagesh: 'kh',
    soundWithoutDageshForTts: 'ch',
  ),
...
const List<HebrewVowel> hebrewVowels = [
  ...
  HebrewVowel(
    name: 'Hirik',
    symbolWithBet: 'בִּ',
    soundDesc: 'i (as in seek)',
    soundForTts: 'ee',
  ),
  HebrewVowel(
    name: 'Holam',
    symbolWithBet: 'בֹּ',
    soundDesc: 'o (as in bore)',
    soundForTts: 'oh',
  ),
  HebrewVowel(
    name: 'Shuruk',
    symbolWithBet: 'וּ',
    soundDesc: 'u (as in cool)',
    soundForTts: 'ooh',
  ),
  HebrewVowel(
    name: 'Kubutz',
